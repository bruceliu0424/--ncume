...
#############################
# 定義不同顏色物體的 HSV 範圍
green_brick_lower_hsv = np.array([35, 50, 50])   # 黃磚下限 HSV
green_brick_upper_hsv = np.array([85, 255, 255])  # 黃磚上限 HSV
# 初始化 ArUco 標記的類型與參數
...
def main():
    ...
    #while True:
        ...
        output, real_points = Find_Suction_Object(green_brick_lower_hsv, green_brick_upper_hsv)
        frame = realsense.Get_RGB_Frame()
